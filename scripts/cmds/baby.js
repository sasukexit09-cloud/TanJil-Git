...
module.exports.onChat = async ({
    ...
    try {
        ...
        if (body.startsWith("baby") || body.startsWith("bby") || body.startsWith("bot") || body.startsWith("jan") || body.startsWith("babu") || body.startsWith("janu")) {
            ...
            const rawReplies = [
  "Can I help you 😒🌷","আমাকে না ডেকে 𝗔𝗬𝗔𝗡 কে ডাক 😇🫦","আমি বস এর সাথে ব্যস্ত আছি 🙈👀🌊","বেবি তুমি কি WI-FI নাকি দেখলেই কানেক্ট হইয়া যায় 🎀","এখন আমার মন ভালো না পরে কথা বলি 💗☺️","তুমি নাকি আমার বস 𝗔𝗬𝗔𝗡 এর বউ 🙈😥"
];
